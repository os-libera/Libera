...
public class OVXActionSetDlSrc extends OVXAction implements VirtualizableAction {

    private OFActionSetDlSrc ofActionSetDlSrc;

    private OVXActionSetDlSrc(OFAction ofAction) {
        super(ofAction);
        this.ofActionSetDlSrc = (OFActionSetDlSrc)ofAction;
    }
    ...
    public void virtualize(OVXSwitch sw, List<OFAction> approvedActions, OVXMatch match)
        ...
        final MacAddress mac = this.ofActionSetDlSrc.getDlAddr();
        ...
        try {
            ...
            approvedActions.add(this.ofActionSetDlSrc);
