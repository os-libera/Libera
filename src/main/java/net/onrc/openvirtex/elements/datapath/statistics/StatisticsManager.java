...
public class StatisticsManager implements TimerTask, OVXSendMsg {
    ...
    public StatisticsManager(PhysicalSwitch sw) {
        ...
        this.sw = sw;
        this.refreshInterval = LiberaController.getInstance()
                .getStatsRefresh();
    ...
    public void sendFlowStatistics(int tid, short port) {
        ...
        //log.info("[{}]Send FlowStatsReq Xid: {}", System.currentTimeMillis(), ofFlowStatsRequest.getXid());
    ...
    public void sendPortStatistics() {
        ...
        //log.info("[{}]Send PortStatsReq Xid: {}", System.currentTimeMillis(), ofPortStatsRequest.getXid());
